...
<head>
    ...
    <title>Assign Sessions — <?php echo e($user->name); ?> — <?php echo e(config('app.name')); ?></title>
...
<div>
<h1 class="text-lg font-bold text-gray-900">Assign Sessions — <?php echo e($user->name); ?></h1>
<p class="text-xs text-gray-500">
Room: <span class="font-semibold text-teal-700"><?php echo e($user->roomName() ?? '—'); ?></span> ·
<span id="selCount">0</span> selected
</p>
</div>
</div>
<a href="<?php echo e(route('admin.room-accounts.index')); ?>" class="text-xs font-medium text-gray-500 hover:text-gray-800">← Back to Room Accounts</a>
</div>
</header>
...
<form method="POST" action="<?php echo e(route('admin.room-accounts.sessions.store', $user)); ?>" id="assignForm">
<?php echo csrf_field(); ?>
<?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $roomName => $roomItems): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<h2 class="text-sm font-bold text-gray-900"><?php echo e($roomName); ?></h2>
<label class="flex items-center gap-2 text-xs font-medium text-indigo-600 cursor-pointer">
<input type="checkbox" class="room-select-all rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" data-room="<?php echo e($roomName); ?>">
Select all in <?php echo e($roomName); ?>
...
<?php if($company): ?>
<span class="ml-2 text-xs text-gray-400">· <?php echo e($company); ?></span>
<?php endif; ?>
<span class="ml-2 inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-semibold bg-gray-100 text-gray-600"><?php echo e($typeLabel); ?></span>
</td>
</tr>
...
<a href="<?php echo e(route('admin.room-accounts.index')); ?>" class="px-5 py-2.5 text-sm font-medium rounded-xl bg-gray-100 text-gray-700 hover:bg-gray-200 transition">Cancel</a>
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/admin/room-accounts/sessions.blade.php ENDPATH**/ ?>