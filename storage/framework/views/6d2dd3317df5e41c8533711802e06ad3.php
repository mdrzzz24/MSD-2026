            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                        ...
                        <form method="POST" action="<?php echo e(route('admin.templates.send-reminder')); ?>" class="p-6 space-y-5">
                            <?php echo csrf_field(); ?>
                            <div>
                                <p class="text-sm text-gray-600 mb-2">
                                    Using template: <strong class="text-violet-700"><?php echo e($template->name); ?></strong> — Subject: <em>"<?php echo e($template->subject); ?>"</em>
                                </p>
                            ...
                            <div class="max-h-80 overflow-y-auto border border-gray-200 rounded-xl divide-y divide-gray-100">
                                <?php $__currentLoopData = $registrants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 cursor-pointer transition">
                                        <input type="checkbox" name="registrant_ids[]" value="<?php echo e($r->id); ?>" class="w-4 h-4 rounded border-gray-300 text-violet-600 focus:ring-violet-500">
                                        <div class="flex-1 min-w-0">
                                            <p class="text-sm font-medium text-gray-900 truncate"><?php echo e($r->display_name); ?></p>
                                            <p class="text-xs text-gray-400 truncate"><?php echo e($r->email); ?></p>
                                        </div>
                                        <span class="text-xs text-gray-400"><?php echo e($r->created_at->format('d M Y')); ?></span>
                                    </label>
                    ...
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                        ...
                        <div class="p-5 space-y-3">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900"><?php echo e($registrants->count()); ?></p>
                            </div>
                            <div>
                                <p class="text-xs text-gray-400 uppercase tracking-wider">Template</p>
                                <p class="text-sm font-medium text-violet-700"><?php echo e($template->name); ?></p>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/admin/templates/send-reminder.blade.php ENDPATH**/ ?>