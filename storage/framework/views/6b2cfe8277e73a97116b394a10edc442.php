    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 mb-6">
        <div class="grid grid-cols-2 sm:grid-cols-5 gap-4">
            ...
            <div><p class="text-xs text-gray-400 uppercase">Reg Status</p>
                <?php if($agendum->registration_open): ?><span class="text-sm font-semibold text-emerald-600">Open</span><?php else: ?><span class="text-sm font-semibold text-gray-400">Closed</span><?php endif; ?></div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\2026-Testing\resources\views/admin/agenda-registrants/detail.blade.php ENDPATH**/ ?>