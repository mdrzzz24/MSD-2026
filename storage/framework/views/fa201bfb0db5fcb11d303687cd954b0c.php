    ...
    <main class="flex-1 lg:ml-64">
        ...
        <div class="p-4 sm:p-6 lg:p-8 max-w-2xl">
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                <form action="<?php echo e(route('admin.admin-emails.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/admin/admin-emails/create.blade.php ENDPATH**/ ?>