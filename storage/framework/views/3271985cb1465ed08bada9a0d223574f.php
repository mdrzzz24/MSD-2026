...
<head>
    ...
    <title>Track Sessions — <?php echo e(config('app.name')); ?></title>
...
<header class="sticky top-0 z-30 bg-white/80 backdrop-blur border-b border-gray-200">
    <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
        <div>
            <h1 class="text-lg font-bold text-gray-900">Track Sessions</h1>
            <p class="text-xs text-gray-500">Platinum &amp; Gold partner sessions linked to a track</p>
        </div>
        <a href="<?php echo e(route('admin.track-sessions.create')); ?>" class="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-medium bg-indigo-500 text-white rounded-xl hover:bg-indigo-600 shadow-sm shadow-indigo-200 transition">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/></svg>Add Track Session
        </a>
    </div>
</header>
<div class="p-4 sm:p-6 lg:p-8">
    ...
    <?php if($items->isEmpty()): ?>
        <div class="bg-white rounded-2xl border border-gray-100 p-12 text-center">
            ...
            <p class="text-gray-500 font-medium">No track sessions yet.</p>
            <p class="text-gray-400 text-sm mt-1">Click the button above to add a new track session.</p>
        </div>
    <?php else: ?>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-50">
                    ...
                    <tr class="hover:bg-gray-50/50">
                        ...
                        <td class="px-5 py-4">
                            <?php if($item->track): ?>
                                <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium bg-indigo-50 text-indigo-700"><?php echo e($item->track->name ?: $item->track->title); ?></span>
                            <?php else: ?>
                        ...
                        <td class="px-5 py-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <a href="<?php echo e(route('admin.track-sessions.edit', $item)); ?>" class="px-3 py-1.5 text-xs font-medium rounded-lg bg-indigo-50 text-indigo-700 hover:bg-indigo-100 transition">Edit</a>
                                <form action="<?php echo e(route('admin.track-sessions.destroy', $item)); ?>" method="POST" onsubmit="return confirm('Delete this session?');">
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/admin/track-sessions/index.blade.php ENDPATH**/ ?>