...
<div class="walkin-shell">
    <div class="walkin-card">
        <img src="<?php echo e(asset('img/logo-msd.png')); ?>" alt="MSD" class="wi-logo">
        ...
        <?php if(isset($errors) && $errors->any()): ?>
            <div class="error-box" role="alert" style="display:flex">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></svg>
                <span><?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php echo e($e); ?><?php if(!$loop->last): ?><br><?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></span>
            </div>
        <?php endif; ?>

        <form id="walkinPublicForm" class="form-grid" method="POST" action="<?php echo e(route('walkin.public.store')); ?>" onsubmit="submitWalkinForm(event)">
            <?php echo csrf_field(); ?>
            ...
            <div class="field"><label>First Name</label><input required name="firstName" value="<?php echo e(old('firstName')); ?>" placeholder="First Name" /><span class="field-err"></span></div>
            <div class="field"><label>Last Name</label><input required name="lastName" value="<?php echo e(old('lastName')); ?>" placeholder="Last Name" /><span class="field-err"></span></div>
            <div class="field">
            ...
            <div class="field"><label>Company Name</label><input required name="company" value="<?php echo e(old('company')); ?>" placeholder="Company Name" /><span class="field-err"></span></div>
            <div class="field"><label>Business Email</label><input required type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="yourname@company.com" /><span class="field-err"></span></div>
            <div class="field">
        ...
        <div id="walkinConfirmation" style="display:none;text-align:center;margin-top:8px">
            ...
            <a href="<?php echo e(route('home1')); ?>" class="btn">Back to Event Website</a>
        </div>
    </div>
...
async function submitWalkinForm(event) {
    ...
    try {
        ...
        var res = await fetch('<?php echo e(route("walkin.public.store")); ?>', {
            method: 'POST',
            headers: {
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/walkin/register.blade.php ENDPATH**/ ?>