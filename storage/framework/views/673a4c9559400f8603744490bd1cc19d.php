...
<head>
    ...
    <title>Invite Client — <?php echo e(config('app.name')); ?></title>
    ...
    <main class="flex-1 lg:ml-64">
        <header class="sticky top-0 z-30 bg-white/80 backdrop-blur border-b border-gray-200">
            <div class="flex items-center h-16 px-4 sm:px-6 lg:px-8 gap-4">
                <a href="<?php echo e(route('admin.management.users')); ?>" class="inline-flex items-center gap-1.5 text-sm text-indigo-600 hover:text-indigo-800 font-medium transition">
        ...
        <div class="p-4 sm:p-6 lg:p-8 max-w-2xl">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                ...
                <form action="<?php echo e(route('admin.management.users.invite')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="space-y-4">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-1.5">Full Name</label>
                            <input type="text" name="name" value="<?php echo e(old('name')); ?>" required placeholder="e.g. John Doe"
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="<?php echo e(old('email')); ?>" required placeholder="client@example.com"
                                   class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 focus:bg-white transition">
                        </div>
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/admin/users/invite.blade.php ENDPATH**/ ?>