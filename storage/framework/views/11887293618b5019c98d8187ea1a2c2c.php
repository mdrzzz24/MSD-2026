                ...
                <tbody class="divide-y divide-gray-50">
                    <?php $__empty_1 = true; $__currentLoopData = $tracks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50/50">
                            ...
                            <td class="px-5 py-4 hidden md:table-cell">
                                <?php if($tr->scanned_count > 0): ?>
                                    <a href="<?php echo e(route('admin.tracks.visitors', $tr)); ?>" class="inline-flex items-center gap-1.5 font-bold text-emerald-600 hover:text-emerald-800">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                                        <?php echo e($tr->scanned_count); ?>
                            ...
                            <td class="px-5 py-4 text-center">
                                <div class="flex justify-center gap-1.5">
                                    ...
                                    <?php endif; ?>
                                    <?php if(Auth::user()->canWrite()): ?>
                                    <button onclick="editTrack(<?php echo e($tr->id); ?>)" class="px-2.5 py-1.5 text-xs font-medium rounded-lg bg-amber-100 text-amber-700 hover:bg-amber-200 transition">Edit</button>
...
window._tracks = <?php echo json_encode($tracksJson, 15, 512) ?>;
