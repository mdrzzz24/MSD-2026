...
(function() {
    ...
    function updatePreview() {
        ...
        html = html
            ...
            .replace(/\{\{\s*login_url\s*\}\}/g, '<?php echo e(url('/login')); ?>')
            ...
            .replace(/\{\{\s*qr_checkin_url\s*\}\}/g, '<?php echo e(url('/login')); ?>')
            .replace(/\{\{\s*qr_link\s*\}\}/g, '<?php echo e(url('/qr-view/sample-qr-token')); ?>');
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/admin/templates/create.blade.php ENDPATH**/ ?>