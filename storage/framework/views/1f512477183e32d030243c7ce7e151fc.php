...
<p style="margin:0 0 4px;font-size:16px;font-weight:700;color:#050d2a;">Workshop Name – <?php echo e($workshopName); ?></p>
...
<tr><td style="padding-bottom:16px;">
<p style="margin:0;font-size:13px;color:#dc2626;font-weight:600;line-height:1.6;">Room Capacity max <?php echo e($workshop_capacity ?? '35'); ?> pax. Please come on time. First Come, First Serve.</p>
</td></tr>
<tr><td style="padding-bottom:16px;text-align:center;">
<?php if($registrant->qr_token): ?>
<img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=<?php echo e(urlencode($registrant->unique_code ?? $registrant->qr_token)); ?>" alt="QR Code" style="width:150px;height:150px;display:block;margin:0 auto;">
<?php endif; ?>
</td></tr>
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/emails/workshop-approved.blade.php ENDPATH**/ ?>