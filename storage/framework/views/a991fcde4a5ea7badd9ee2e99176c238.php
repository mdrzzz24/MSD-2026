...
<?php echo $__env->make('admin.partials.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <main class="flex-1 lg:ml-64">
        ...
        <div class="p-4 sm:p-6 lg:p-8 space-y-6">
            ...
            <?php if(Auth::user()->isSuperAdmin()): ?>
            <?php $agendaVisible = \Illuminate\Support\Facades\Cache::get('agenda_sections_visible', true); ?>
            <div class="flex items-center gap-4 bg-white rounded-2xl border border-gray-200 px-5 py-4 shadow-sm">
                <div>
                    <p class="text-sm font-bold text-gray-900">New Agenda Section (Schedule tabs)</p>
                    <p class="text-xs text-gray-500">
                        Status:
                        <?php if($agendaVisible): ?>
                ...
                <form action="<?php echo e(route('admin.toggle-agenda-sections')); ?>" method="POST" class="ml-auto">
                    <?php echo csrf_field(); ?>
                    <button type="submit" class="px-4 py-2 text-sm font-semibold rounded-xl transition <?php echo e($agendaVisible ? 'bg-red-500 text-white hover:bg-red-600' : 'bg-emerald-500 text-white hover:bg-emerald-600'); ?>">
                        <?php echo e($agendaVisible ? 'Hide Agenda Section' : 'Show Agenda Section'); ?>
