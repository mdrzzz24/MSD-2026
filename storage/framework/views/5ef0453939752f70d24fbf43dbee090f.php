...
<head>
    ...
    <title>Walk-in Registration — <?php echo e(config('app.name')); ?></title>
...
<div class="p-4 sm:p-6 lg:p-8">
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8">
            ...
            <form action="<?php echo e(route('admin.walkin.store')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="notes" rows="2" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 focus:bg-white transition resize-y" placeholder="Optional notes..."><?php echo e(old('notes')); ?></textarea>
                    </div>
                </div>
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/admin/walkin.blade.php ENDPATH**/ ?>