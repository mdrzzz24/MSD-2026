...
<header class="hero" id="top">
  ...
  <div class="container hero-content">
    ...
    <div class="hero-logo-row">
      <img src="<?php echo e(asset('img/logo-msd.png')); ?>" alt="MSD" style="height:clamp(50px,9vw,90px);width:auto">
    </div>
...
<section id="sponsors" class="reveal-scale">
  <div class="container">
    ...
    <div class="sponsors-block-3">
      ...
      <div class="sponsor-grid-3">
        <div class="sponsor-card"><img src="<?php echo e(asset('img/logo-metrodata.png')); ?>" alt="Metrodata Electronics"></div>
        <div class="sponsor-card"><img src="<?php echo e(asset('img/METRODATA-GROUP/MII.png')); ?>" alt="MII"></div>
        <div class="sponsor-card"><img src="<?php echo e(asset('img/METRODATA-GROUP/SMI.png')); ?>" alt="SMI"></div>
        <div class="sponsor-card"><img src="<?php echo e(asset('img/METRODATA-GROUP/SOLTIUS.png')); ?>" alt="Soltius"></div>
        <div class="sponsor-card"><img src="<?php echo e(asset('img/METRODATA-GROUP/FMI.png')); ?>" alt="FMI"></div>
        <div class="sponsor-card"><img src="<?php echo e(asset('img/METRODATA-GROUP/SINERGI TRANSFORMASI DIGITAL-01.png')); ?>" alt="Sinergi"></div>
        <div class="sponsor-card"><img src="<?php echo e(asset('img/METRODATA-GROUP/MY ICON TECHNOLOGY.png')); ?>" alt="MIT"></div>
        <div class="sponsor-card"><img src="<?php echo e(asset('img/METRODATA-GROUP/CMI.png')); ?>" alt="CMI"></div>
      </div>
    </div>
  </div>
</section>
...
<section id="register" class="reveal-up">
  <div class="container">
    ...
    <div class="form-wrap">
      <form id="regForm" class="form-grid" method="POST" action="<?php echo e(route('register.submit')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="field"><label>Business Email</label><input required type="email" name="email" placeholder="yourname@company.com" /><span class="field-err" data-field="email"></span><small style="color:#94a3b8;font-size:11px;">Please use your company email. Free email (Gmail, Yahoo, etc.) will not be accepted.</small></div>
        <div class="field"><label>Mobile Phone</label><div class="phone-wrapper" style="display:flex;align-items:stretch;gap:0;"><span class="phone-prefix" id="phonePrefix3" style="display:flex;align-items:center;padding:12px 10px;background:rgba(255,255,255,.08);border:1px solid var(--line,#d1d5db);border-right:none;border-radius:10px 0 0 10px;font-size:14px;color:rgba(255,255,255,.45);white-space:nowrap;flex-shrink:0;transition:border-color .25s,box-shadow .25s,background .25s;">+62</span><input required name="phone" placeholder="815-xxx-xxxx" class="phone-input" id="phoneInput3" style="flex:1;border-radius:0 10px 10px 0;border-left:none;" oninput="updatePhonePrefix3(this)" onfocus="this.parentNode.querySelector('.phone-prefix').style.borderColor='var(--pink,#e91e63)';this.parentNode.querySelector('.phone-prefix').style.boxShadow='0 0 0 3px rgba(233,30,99,.15)';this.parentNode.querySelector('.phone-prefix').style.background='rgba(255,255,255,.12)'" onblur="this.parentNode.querySelector('.phone-prefix').style.borderColor='';this.parentNode.querySelector('.phone-prefix').style.boxShadow='';updatePhonePrefix3(this)" /></div><span class="field-err" data-field="phone"></span></div>
<script>function updatePhonePrefix3(el){var v=el.value.replace(/[^0-9]/g,'').replace(/^0/,'');el.value=v;var p=el.parentNode.querySelector('.phone-prefix');if(v){p.style.background='#fff';p.style.color='#374151'}else{p.style.background='rgba(255,255,255,.08)';p.style.color='rgba(255,255,255,.45)'}}
document.addEventListener('DOMContentLoaded',function(){var e=document.getElementById('phoneInput3');if(e&&e.value)updatePhonePrefix3(e)});</script>
        <div class="field">
  ...
  <div style="background:#fff; border-radius:16px; box-shadow:0 25px 50px rgba(0,0,0,0.25); width:100%; max-width:448px; overflow:hidden; animation:fadeInUp 0.3s ease-out;">
    <div style="padding:32px; text-align:center;">
      ...
      <div style="background:#fffbeb; border:1px solid #fde68a; border-radius:12px; padding:16px; font-size:14px; color:#d97706; margin-bottom:24px; text-align:left;">
        ...
        Once your registration is <strong>approved</strong>, you will receive an email containing your login <strong>password</strong> to access the participant dashboard at <strong style="word-break:break-all;"><?php echo e(request()->getSchemeAndHttpHost()); ?>/registrant/login</strong>.
      </div>
...
<script src="<?php echo e(asset('js/main3.js')); ?>"></script>
</body>
</html>
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/home3.blade.php ENDPATH**/ ?>