...
<div class="p-4 sm:p-6 lg:p-8"><div class="max-w-xl"><div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8">
    ...
    <form action="<?php echo e(route('admin.agenda.store')); ?>" method="POST" class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div><label class="block text-sm font-semibold text-gray-700 mb-1.5">End Time</label><input type="time" name="end_time" value="<?php echo e(old('end_time', request('end_time'))); ?>" required class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 focus:bg-white transition"></div>
        </div>
        ...
        <div class="border-t border-gray-100 pt-4 mt-2">
            ...
            <div class="grid grid-cols-2 gap-4 mt-3">
                ...
                <div>
                    ...
                    <input type="number" name="capacity" value="<?php echo e(old('capacity', 0)); ?>" min="0" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 focus:bg-white transition">
                </div>
                <div class="flex items-end gap-4 pb-2">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="is_registrable" value="1" <?php echo e(old('is_registrable') ? 'checked' : ''); ?> class="w-4 h-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                        <span class="text-sm font-medium text-gray-700">Open for Registration</span>
                    </label>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="registration_open" value="1" <?php echo e(old('registration_open', true) ? 'checked' : ''); ?> class="w-4 h-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
...
<?php /**PATH C:\xampp\htdocs\2026-Testing\resources\views/admin/agenda/create.blade.php ENDPATH**/ ?>