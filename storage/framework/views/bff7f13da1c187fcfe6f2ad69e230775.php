                        ...
                        <tr class="hover:bg-gray-50/50">
                            ...
                            <td class="px-5 py-4 text-center">
                                <div class="flex justify-center gap-1.5">
                                    ...
                                    <a href="<?php echo e(route('admin.workshops.tracks', $w)); ?>" class="px-2.5 py-1.5 text-xs font-medium rounded-lg bg-teal-100 text-teal-700 hover:bg-teal-200 transition">Tracks</a>
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/admin/workshops/index.blade.php ENDPATH**/ ?>