<?php $__empty_2 = true; $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
    <?php
    ...
    <tr class="hidden session-detail-row" id="<?php echo e($rowId); ?>">
        <td colspan="4" class="px-5 py-4 bg-gray-50/60 border-t border-gray-100">
            <div class="space-y-3">
                <?php $__empty_3 = true; $__currentLoopData = $s->feedback->sortByDesc('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_3 = false; ?>
