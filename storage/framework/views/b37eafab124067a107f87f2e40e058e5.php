...
<title>Impersonate — <?php echo e(config('app.name')); ?></title>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-3 text-right">
                        <form action="<?php echo e(route('admin.management.impersonate.start', $user)); ?>" method="POST" class="inline">
                            <?php echo csrf_field(); ?>
...
<div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                <?php $__empty_1 = true; $__currentLoopData = $registrants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $registrant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr class="hover:bg-gray-50 transition">
                    <td class="px-6 py-3 font-medium text-gray-900"><?php echo e($registrant->name); ?></td>
                    <td class="px-6 py-3 text-gray-500"><?php echo e($registrant->email); ?></td>
                    <td class="px-6 py-3 text-gray-400 text-xs font-mono"><?php echo e($registrant->unique_code ?? '—'); ?></td>
                    <td class="px-6 py-3 text-right">
                        <form action="<?php echo e(route('admin.management.impersonate.registrant', $registrant)); ?>" method="POST" class="inline">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-amber-50 text-amber-700 hover:bg-amber-100 border border-amber-200 transition">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z"/></svg>
                                Impersonate
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/admin/management/impersonate.blade.php ENDPATH**/ ?>