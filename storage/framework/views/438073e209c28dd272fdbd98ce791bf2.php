          ...
          <?php $__currentLoopData = $panel['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if($showBreak): ?>
              <div class="agenda-break-banner">
                <div class="b-text">
                  <span class="b-label"><?php echo e($breakLabel); ?></span>
                </div>
              </div>
            <?php endif; ?>
            <div class="agenda-row<?php echo e(($panel['key'] === 'track' && ($it->track_is_last_in_slot ?? false)) ? ' agenda-row-last' : ''); ?>" onclick="openAgendaModal(<?php echo e($it->id); ?>)" title="View session details">
              <div class="agenda-col-time">
                ...
                <?php if($it->room): ?>
                  <div class="aroom">
                    ...
                    <span class="aroom-value"><?php echo e($it->room); ?></span>
                  </div>
                <?php endif; ?>
              </div>
              <?php
                ...
                <?php if($cleanHl !== ''): ?>
                  <span class="agenda-topic-highlights">
                    <?php $__currentLoopData = preg_split('/\r\n|\r|\n/', $cleanHl); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <?php if(trim($line) !== ''): ?>
                        <span class="agenda-hl-item">• <?php echo e(trim($line)); ?></span>
                      <?php endif; ?>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </span>
                <?php endif; ?>
                ...
                <?php $__currentLoopData = $spk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="agenda-speaker-card">
                    <?php if($spPhoto): ?>
                      ...
                      <div class="agenda-sp-initial" style="display:none;"><?php echo e(mb_strtoupper(mb_substr($sp->name, 0, 1))); ?></div>
                    <?php else: ?>
                      <div class="agenda-sp-initial"><?php echo e(mb_strtoupper(mb_substr($sp->name, 0, 1))); ?></div>
                    <?php endif; ?>
                    <div class="agenda-sp-info">
                      <span class="agenda-speaker-name"><?php echo e($msdTitle($sp->name)); ?></span>
                      <?php if($spRole): ?>
              ...
              <div class="agenda-col-action">
                <?php if($panel['key'] === 'track' && in_array(trim((string) $it->room), ['Ballroom A', 'Ballroom B', 'Ballroom C'], true)): ?>
...
window._agendaData = <?php echo json_encode($agendaItems->keyBy('id')->map(function ($item) use ($timeSlots) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('notifMessage').innerHTML = '<?php echo str_replace(["'"], ["\\'"], session('info')); ?>';
    document.getElementById('successModal').style.display = 'flex';
    document.body.style.overflow = 'hidden';
    setTimeout(function() {
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/home1.blade.php ENDPATH**/ ?>