...
<h1 style="margin:0;font-size:22px;font-weight:800;color:#050d2a;">Workshop Registration Rejected</h1>
</td></tr>
<tr><td style="text-align:center;padding-bottom:20px;">
...
<p style="margin:12px 0 0;font-size:15px;color:#6b7280;line-height:1.6;">We regret to inform you that your registration for the workshop <strong style="color:#050d2a;"><?php echo e($workshopName); ?></strong> has been <strong style="color:#ef4444;">rejected</strong>.</p>
<?php if($adminNotes): ?>
