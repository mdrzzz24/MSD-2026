...
<header class="hero hero-compact" id="top">
  ...
  <div class="container hero-content">
    <img src="<?php echo e(asset('img/logo-msd.png')); ?>" alt="MSD" style="height:clamp(56px,9vw,88px);width:auto">
    ...
    <div class="walkin-wrap">
      <div class="form-wrap" id="walkinSuccessContent" style="margin-top:0;text-align:center;display:block;opacity:0;transform:translateY(10px);transition:opacity .5s ease,transform .5s ease">
        ...
        <div style="background:rgba(255,255,255,.06);border:1px solid var(--line);border-radius:12px;padding:18px 20px;max-width:420px;margin:0 auto 24px;text-align:left;font-size:14px">
          <div style="display:flex;justify-content:space-between;gap:12px;padding:4px 0"><span style="color:var(--muted)">Name</span><strong style="color:#fff"><?php echo e($registrant->name); ?></strong></div>
          <div style="display:flex;justify-content:space-between;gap:12px;padding:4px 0"><span style="color:var(--muted)">Email</span><span style="color:#fff"><?php echo e($registrant->email); ?></span></div>
          <div style="display:flex;justify-content:space-between;gap:12px;padding:4px 0"><span style="color:var(--muted)">Unique Code</span><span style="color:#fbbf24;font-family:monospace;font-weight:600"><?php echo e($registrant->unique_code); ?></span></div>
        </div>
...
<div id="walkinSuccessModal" style="display:flex;position:fixed;inset:0;z-index:9999;align-items:center;justify-content:center;background:rgba(5,13,42,.78);backdrop-filter:blur(10px);padding:16px;">
  <div style="background:rgba(255,255,255,.06);backdrop-filter:blur(12px);border:1px solid rgba(255,255,255,.1);border-radius:20px;box-shadow:0 25px 60px rgba(0,0,0,.5),inset 0 1px 0 rgba(255,255,255,.08);width:100%;max-width:420px;overflow:hidden;animation:fadeInUp .35s ease-out;text-align:center;padding:36px 32px 28px;">
    ...
    <p style="font-size:14px;color:#94a3b8;line-height:1.6;margin-bottom:24px;">Thank you, <strong style="color:#fff"><?php echo e($registrant->name); ?></strong>! Your walk-in registration form has been submitted successfully.</p>
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/walkin/success.blade.php ENDPATH**/ ?>