...
<div class="bg-emerald-50 border border-emerald-200 text-emerald-800 px-5 py-4 rounded-2xl text-sm"><?php echo session('success'); ?></div>
<?php endif; ?>
<?php if(session('error')): ?>
<div class="bg-red-50 border border-red-200 text-red-800 px-5 py-4 rounded-2xl text-sm"><?php echo e(session('error')); ?></div>
<?php endif; ?>
...
<button onclick="editUser('<?php echo e($u->id); ?>', '<?php echo e($u->name); ?>', '<?php echo e($u->email); ?>', '<?php echo e($u->role); ?>')" class="text-xs text-amber-600 hover:text-amber-800 font-medium mr-2">Edit</button>
<?php if($u->id !== auth()->id()): ?>
