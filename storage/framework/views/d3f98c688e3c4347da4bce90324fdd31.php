        ...
        <tr>
            <td align="center" style="padding:32px 16px;">
                <table width="560" cellpadding="0" cellspacing="0" style="max-width:560px;width:100%;border-radius:16px;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                        <td>
                            <img src="<?php echo e($message?->embed(public_path('img/QRHeader.png')) ?: asset('img/QRHeader.png')); ?>" alt="MSD 2026" style="width:100%;height:auto;display:block;max-width:560px;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background:#ffffff;padding:36px 32px;">
                            <p style="margin:0 0 6px;font-size:16px;color:#374151;line-height:1.6;">Hello <strong style="color:#e91e63;"><?php echo e($name); ?></strong>,</p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background:#f9fafb;border-radius:12px;border:1px solid #e5e7eb;margin-bottom:24px;">
                                <tr>
                                    <td style="padding:16px 20px;">
                                        ...
                                        <p style="margin:4px 0 0;font-size:16px;font-weight:600;color:#111827;"><?php echo e($email); ?></p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center" style="background:linear-gradient(135deg,#ff3d6e,#e91e63);border-radius:999px;box-shadow:0 8px 24px rgba(233,30,99,0.35);">
                                        <a href="<?php echo e($setupUrl); ?>" style="display:inline-block;padding:14px 44px;font-size:15px;font-weight:700;color:#ffffff;text-decoration:none;letter-spacing:0.02em;">
                                            Set Up My Password
                                        </a>
                                    </td>
                                </tr>
                ...
                <p style="margin:16px 0 0;font-size:11px;color:#9ca3af;text-align:center;">&copy; <?php echo e(date('Y')); ?> Metrodata Group. All rights reserved.</p>
            </td>
        </tr>
    </table>
</body>
</html>
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/emails/client-invitation.blade.php ENDPATH**/ ?>