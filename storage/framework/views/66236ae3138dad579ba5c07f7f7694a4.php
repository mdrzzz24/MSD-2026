...
<head>
    ...
    <title>Scan QR — <?php echo e($agendum->title); ?> — <?php echo e(config('app.name')); ?></title>
...
<header class="sticky top-0 z-30 bg-white/80 backdrop-blur border-b border-gray-200">
    <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
        <div class="flex items-center gap-4">
            ...
            <h1 class="text-lg font-bold text-gray-900">Scan QR — <?php echo e($agendum->title); ?></h1>
        </div>
        <a href="<?php echo e(route('admin.agenda.visitors', $agendum)); ?>" class="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-medium rounded-lg border border-gray-200 text-gray-600 bg-white hover:bg-gray-50 transition">
...
<script>
const scanUrl = '<?php echo e(route('admin.agenda.scan-process', $agendum)); ?>';
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/admin/agenda/scan.blade.php ENDPATH**/ ?>