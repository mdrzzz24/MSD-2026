...
<head>
    ...
    <title>Registrants: <?php echo e($track->name ?: $track->title); ?> — <?php echo e(config('app.name')); ?></title>
...
<header class="sticky top-0 z-30 bg-white/80 backdrop-blur border-b border-gray-200">
    <div class="flex items-center h-16 px-4 sm:px-6 lg:px-8 gap-4">
        ...
        <span class="text-gray-300">/</span><h1 class="text-lg font-bold text-gray-900 truncate"><?php echo e($track->name ?: $track->title); ?></h1>
    </div>
</header>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 mb-6">
        <div class="grid grid-cols-2 sm:grid-cols-5 gap-4">
            ...
            <div><p class="text-xs text-gray-400 uppercase">Status</p>
                <?php if($firstAgenda): ?>
                    <?php if($firstAgenda->is_registrable): ?><span class="inline-flex px-2 py-0.5 rounded-full text-xs font-semibold bg-emerald-50 text-emerald-700">Open</span><?php else: ?><span class="inline-flex px-2 py-0.5 rounded-full text-xs font-semibold bg-gray-100 text-gray-600">Closed</span><?php endif; ?>
                <?php else: ?>
        ...
        <div class="overflow-x-auto"><table class="w-full table-fixed">
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <tr class="hover:bg-gray-50/50">
                    ...
                    <td class="px-4 py-3 max-w-0"><span class="text-xs text-gray-600 truncate block" title="<?php echo e($r->agenda_item_title ?? ''); ?>"><?php echo e($r->agenda_item_title ?? '—'); ?></span></td>
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/admin/tracks/registrants.blade.php ENDPATH**/ ?>