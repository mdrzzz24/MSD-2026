    ...
    <div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-gray-500"><?php echo e($template->name); ?> — <?php echo e(\App\Models\EmailTemplate::typeLabel($template->type)); ?></p>
            </div>
            <div class="flex items-center gap-2">
                <span class="text-xs text-gray-400">Subject: <strong><?php echo e($template->subject); ?></strong></span>
                <a href="<?php echo e(route('admin.templates.index')); ?>" class="px-3 py-1.5 text-xs font-medium rounded-lg bg-gray-100 text-gray-600 hover:bg-gray-200 transition">← Back</a>
            </div>
        </div>
