...
<button onclick="convertSource('<?php echo e($src->utm_source); ?>')" class="inline-flex items-center gap-1 px-3 py-1.5 text-xs font-medium rounded-lg bg-emerald-500 text-white hover:bg-emerald-600 transition shadow-sm" title="Create UTM Link">
