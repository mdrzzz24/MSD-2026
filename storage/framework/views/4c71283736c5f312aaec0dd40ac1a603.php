...
<head>
    ...
    <title>Feedback Templates — <?php echo e(config('app.name')); ?></title>
    ...
    <main class="flex-1 lg:ml-64">
        <header class="sticky top-0 z-30 bg-white/80 backdrop-blur border-b border-gray-200">
            <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                ...
                <a href="<?php echo e(route('admin.feedback.templates.create')); ?>" class="px-4 py-2 text-sm font-semibold rounded-xl bg-indigo-500 text-white hover:bg-indigo-600 shadow-sm transition">
                    + New Template
                </a>
            </div>
        </header>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
                <?php $__empty_1 = true; $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition overflow-hidden">
                        <div class="px-5 py-4 border-b border-gray-100">
                            <h3 class="text-sm font-bold text-gray-900"><?php echo e($t->name); ?></h3>
                            <?php if($t->description): ?>
                                <p class="text-xs text-gray-500 mt-0.5"><?php echo e($t->description); ?></p>
                            <?php endif; ?>
                        </div>
                        <div class="px-5 py-3 flex items-center justify-between text-xs text-gray-500">
                            <span><?php echo e($t->questions_count); ?> question(s)</span>
                        ...
                        <div class="px-5 py-3 bg-gray-50/50 border-t border-gray-100 flex items-center gap-2">
                            <a href="<?php echo e(route('admin.feedback.templates.edit', $t)); ?>" class="px-3 py-1.5 text-xs font-medium rounded-lg bg-amber-50 text-amber-700 hover:bg-amber-100 border border-amber-200 transition">Edit</a>
                            <form action="<?php echo e(route('admin.feedback.templates.destroy', $t)); ?>" method="POST" class="inline" onsubmit="return confirm('Delete template &quot;<?php echo e($t->name); ?>&quot;?')">
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="md:col-span-2 xl:col-span-3 text-center py-16">
                        ...
                        <a href="<?php echo e(route('admin.feedback.templates.create')); ?>" class="inline-block mt-3 text-sm font-medium text-indigo-600 hover:text-indigo-800">Create your first template →</a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/admin/feedback/templates.blade.php ENDPATH**/ ?>