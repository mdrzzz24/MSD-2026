...
<h1 style="margin:0;font-size:22px;font-weight:800;color:#050d2a;">Session Registration Rejected</h1>
</td></tr>
<tr><td style="text-align:center;padding-bottom:20px;">
...
<p style="margin:12px 0 0;font-size:15px;color:#6b7280;line-height:1.6;">We regret to inform you that your registration for the session <strong style="color:#050d2a;"><?php echo e($sessionName); ?></strong> has been <strong style="color:#ef4444;">rejected</strong>.</p>
<?php if($adminNotes): ?>
<p style="margin:16px 0 0;padding:14px 18px;background:#fef2f2;border:1px solid #fecaca;border-radius:10px;font-size:14px;color:#991b1b;line-height:1.5;"><strong>Reason:</strong> <?php echo e($adminNotes); ?></p>
<?php endif; ?>
</td></tr>
</table>
</td></tr>
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/emails/track-rejected.blade.php ENDPATH**/ ?>