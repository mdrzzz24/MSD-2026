                                ...
                                <div class="cell-item items-center">
                                    <span class="cell-title">
                                        <?php if($fullRow->category): ?>
                                            <span class="tag <?php echo e(\App\Models\AgendaItem::categoryClass($fullRow->category)); ?>"><?php echo e($fullRow->title); ?></span>
                                        <?php else: ?>
                                    ...
                                    <div class="cell-actions justify-center">
                                        ...
                                        <?php if($fullRow->is_registrable): ?>
                                        <form action="<?php echo e(route('admin.agenda.toggle-registration', $fullRow)); ?>" method="POST" style="display:inline">
                                            <?php echo csrf_field(); ?>
                                            <button class="<?php echo e($fullRow->registration_open ? 'bg-emerald-100 text-emerald-700 hover:bg-emerald-200' : 'bg-red-100 text-red-600 hover:bg-red-200'); ?>"><?php echo e($fullRow->registration_open ? 'Open' : 'Closed'); ?></button>
                                        </form>
                                        <?php endif; ?>
