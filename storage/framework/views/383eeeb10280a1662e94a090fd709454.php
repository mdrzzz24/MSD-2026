...
<header class="sticky top-0 z-30 bg-white/80 backdrop-blur border-b border-gray-200">
    <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="<?php echo e(route('admin.tracks.monitoring.export-attendees')); ?>" class="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-medium rounded-lg border border-emerald-200 text-emerald-700 bg-emerald-50 hover:bg-emerald-100 transition" title="Export all workshop & track attendees (scanned people) as CSV">
