...
<?php $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wsId => $groupLinks): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<?php
...
?>
<div>
<div class="px-5 py-3 bg-gray-50/60 border-b border-gray-100 flex items-center justify-between gap-2 cursor-pointer select-none ws-group-toggle" data-target="ws-body-<?php echo e($loop->index); ?>">
<div class="flex items-center gap-2">
<?php if($gWorkshop): ?>
<span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-teal-50 text-teal-700 border border-teal-200">🎯 <?php echo e($gName); ?></span>
<?php else: ?>
...
<?php endif; ?>
<span class="text-xs text-gray-500"><?php echo e($groupLinks->count()); ?> link<?php echo e($groupLinks->count() > 1 ? 's' : ''); ?> · <strong class="text-gray-700"><?php echo e($gRegs); ?></strong> registration<?php echo e($gRegs === 1 ? '' : 's'); ?></span>
</div>
...
<div id="ws-body-<?php echo e($loop->index); ?>" class="ws-group-body hidden">
...
<?php $__currentLoopData = $groupLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php if($regs > 0): ?>
<a href="<?php echo e(route('admin.workshops.utm-links.registrants', $link)); ?>" class="text-sm font-bold text-indigo-600 hover:text-indigo-800 hover:underline"><?php echo e($regs); ?></a>
<?php else: ?>
...
<?php if($regs > 0): ?>
<a href="<?php echo e(route('admin.workshops.utm-links.registrants', $link)); ?>" class="p-1.5 text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg transition" title="View Registrants">
