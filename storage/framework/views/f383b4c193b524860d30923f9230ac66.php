        ...
        <header class="sticky top-0 z-30 bg-white/80 backdrop-blur border-b border-gray-200">
            <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center gap-2">
                    <a href="<?php echo e(route('admin.registrants.export-csv', request()->only(['status', 'utm_source', 'utm_medium', 'utm_campaign', 'direct', 'search', 'profile', 'source', 'marking', 'date_from', 'date_to']))); ?>"
            ...
            <form method="GET" action="<?php echo e(route('admin.registrants.index')); ?>" class="bg-white rounded-2xl border border-gray-100 shadow-sm p-4">
                ...
                <div class="flex flex-wrap items-end gap-3">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <?php if(request('profile') || request('source') || request('marking') || request('date_from') || request('date_to')): ?>
                            <a href="<?php echo e(route('admin.registrants.index', request()->except(['profile', 'source', 'marking', 'date_from', 'date_to']))); ?>" class="px-4 py-2 text-xs font-medium rounded-xl bg-gray-100 text-gray-600 hover:bg-gray-200 transition">Clear</a>
                        <?php endif; ?>
                    </div>
                </div>
            </form>
                                    ...
                                    <td class="px-3 py-3 text-center hidden sm:table-cell">
                                        ...
                                        <div class="flex items-center justify-center gap-1">
                                            ...
                                            <div class="flex items-center gap-1">
                                                ...
                                                <button <?php if(!$r->hasClientRemark()): ?> onclick="openRejectReason(<?php echo e($r->id); ?>, this)" <?php endif; ?>
