...
<span class="text-xs text-gray-400"><?php echo e($files->count()); ?> file</span>
</div>
...
<form action="<?php echo e(route('admin.management.backup.destroy', $file['name'])); ?>" method="POST" class="inline" onsubmit="return confirm('Hapus file backup <?php echo e($file['name']); ?>?')">
