...
<title>Database Backup — <?php echo e(config('app.name')); ?></title>
...
<form action="<?php echo e(route('admin.management.backup.store')); ?>" method="POST" onsubmit="return startBackup(this)">
<?php echo csrf_field(); ?>
...
<span class="text-xs text-gray-400"><?php echo e($files->count()); ?> file(s)</span>
</div>
...
<td class="px-5 py-4"><span class="text-sm font-semibold text-gray-900"><?php echo e($file['name']); ?></span></td>
<td class="px-5 py-4"><span class="text-sm text-gray-600"><?php echo e(number_format($file['size'] / 1048576, 2)); ?> MB</span></td>
<td class="px-5 py-4"><span class="text-sm text-gray-500"><?php echo e(\Carbon\Carbon::createFromTimestamp($file['modified'])->format('d M Y H:i')); ?></span></td>
<td class="px-5 py-4 text-center">
<a href="<?php echo e(route('admin.management.backup.download', $file['name'])); ?>" class="text-xs text-indigo-600 hover:text-indigo-800 font-medium mr-3">Download</a>
<button type="button" onclick="useForRestore('<?php echo e($file['name']); ?>')" class="text-xs text-amber-600 hover:text-amber-800 font-medium mr-3">Restore</button>
<form action="<?php echo e(route('admin.management.backup.destroy', $file['name'])); ?>" method="POST" class="inline" onsubmit="return confirm('Delete backup file <?php echo e($file['name']); ?>?')">
...
<form action="<?php echo e(route('admin.management.backup.restore')); ?>" method="POST" enctype="multipart/form-data" class="p-5 space-y-4" onsubmit="return confirmRestore(this)">
<?php echo csrf_field(); ?>
<div>
...
<option value="<?php echo e($file['name']); ?>"><?php echo e($file['name']); ?> (<?php echo e(number_format($file['size'] / 1048576, 2)); ?> MB)</option>
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/admin/management/backup.blade.php ENDPATH**/ ?>