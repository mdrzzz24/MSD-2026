...
<aside class="hidden lg:flex lg:flex-col w-64 bg-white border-r border-gray-200 fixed inset-y-0 z-40">
    ...
    <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto">
        ...
        <a href="<?php echo e(route('admin.walkin.form')); ?>"
           class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium ml-6 <?php echo e(request()->routeIs('admin.walkin.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-100'); ?> transition">
        ...
        <a href="<?php echo e(route('admin.track-sessions.index')); ?>"
           class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium <?php echo e(request()->routeIs('admin.track-sessions.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-100'); ?> transition">
