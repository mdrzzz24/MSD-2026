...
<head>
    ...
    <title>Registrant Login — <?php echo e(config('app.name')); ?></title>
    ...
    <div class="flex-1 flex items-center justify-center bg-gray-50 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-md animate-fade-in">
            ...
            <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/60 p-8 sm:p-10 border border-gray-100">
                ...
                <form action="<?php echo e(route('registrant.login.attempt')); ?>" method="POST" class="space-y-5">
                    <?php echo csrf_field(); ?>
                    <div>
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/registrant/login.blade.php ENDPATH**/ ?>