                                ...
                                <tr class="hover:bg-gray-50/50 transition">
                                    <td class="px-5 py-4">
                                        <div class="flex items-center gap-3">
                                            <div class="w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0 <?php echo e($t->type === 'approval' ? 'bg-emerald-100 text-emerald-600' : 'bg-red-100 text-red-600'); ?>">
