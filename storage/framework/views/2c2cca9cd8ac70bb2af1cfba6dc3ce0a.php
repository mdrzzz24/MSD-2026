...
<head>
    ...
    <title>Registrants: <?php echo e($workshop->title); ?> — <?php echo e(config('app.name')); ?></title>
...
<header class="sticky top-0 z-30 bg-white/80 backdrop-blur border-b border-gray-200">
    <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
        <div class="flex items-center gap-4">
            ...
            <h1 class="text-lg font-bold text-gray-900 truncate"><?php echo e($workshop->title); ?></h1>
        </div>
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <?php $__currentLoopData = $registrants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="hover:bg-gray-50/50 transition">
                                ...
                                <td class="px-4 py-3.5"><a href="<?php echo e(route('admin.registrants.show', $r)); ?>" class="text-sm font-semibold text-indigo-600 hover:text-indigo-800 hover:underline"><?php echo e($r->display_name); ?></a></td>
                                <td class="px-4 py-3.5"><span class="text-sm text-gray-600 truncate-cell block"><?php echo e($r->email); ?></span></td>
                                <td class="px-4 py-3.5 hidden md:table-cell"><span class="text-sm text-gray-600"><?php echo e($r->phone ?? '—'); ?></span></td>
                                <td class="px-4 py-3.5 hidden lg:table-cell"><span class="text-sm text-gray-600 truncate-cell block"><?php echo e($r->company ?? '—'); ?></span></td>
                                <td class="px-4 py-3.5 hidden xl:table-cell"><span class="text-sm text-gray-600"><?php echo e($r->job_title ?? '—'); ?></span></td>
                                <td class="px-4 py-3.5 text-center">
                                    ...
                                    <?php elseif($wsStatus === 'rejected'): ?>
                                        <span class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-semibold bg-red-50 text-red-700 border border-red-200" title="<?php echo e($r->pivot->admin_notes ?? ''); ?>"><span class="w-1.5 h-1.5 rounded-full bg-red-500"></span>Rejected</span>
                                    <?php else: ?>
