        ...
        <div class="border-t border-gray-100 pt-4 mt-2">
                ...
                <div>
                    ...
                    <select name="track_id" id="trackSelect" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 focus:bg-white transition" onchange="onTrackSelect(this)">
                        ...
                        <?php $__currentLoopData = $trackList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($tr->id); ?>" data-title="<?php echo e(e($tr->title)); ?>" data-desc="<?php echo e(e($tr->description)); ?>" <?php echo e(old('track_id', $agendum->track_id)==$tr->id?'selected':''); ?>><?php echo e($tr->title); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
            ...
            <div class="grid grid-cols-2 gap-4 mt-3">
                ...
                <div class="flex items-end gap-4 pb-2">
                    ...
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="registration_open" value="1" <?php echo e(old('registration_open', $agendum->registration_open) ? 'checked' : ''); ?> class="w-4 h-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
...
<?php /**PATH C:\xampp\htdocs\2026-Testing\resources\views/admin/agenda/edit.blade.php ENDPATH**/ ?>