...
<head>
    ...
    <title>Set Up Password — <?php echo e(config('app.name')); ?></title>
...
<body class="min-h-screen flex font-sans">
    ...
    <div class="hidden lg:flex lg:w-5/12 xl:w-1/2" style="background: url('<?php echo e(asset('img/background.png')); ?>') no-repeat center center;background-size:cover;position:relative;">
        ...
        <div class="relative z-10 flex flex-col items-center justify-center text-center px-12 w-full">
            <img src="<?php echo e(asset('img/logo-msd.png')); ?>" alt="MSD" style="height:clamp(50px,8vw,90px);width:auto;filter:drop-shadow(0 0 20px rgba(0,212,255,.3))" class="mx-auto mb-6">
        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/60 p-8 sm:p-10 border border-gray-100">
                <?php if(session('success')): ?>
                    <div class="bg-emerald-50 border border-emerald-200 text-emerald-800 px-4 py-3 rounded-xl mb-6 flex items-start gap-3 text-sm">
                ...
                <?php if(isset($user) && $user): ?>
                    <div class="text-center mb-6">
                        ...
                        <p class="text-sm text-gray-500">Welcome, <strong class="text-gray-900"><?php echo e($user->name); ?></strong></p>
                        <p class="text-xs text-gray-400"><?php echo e($user->email); ?></p>
                    </div>

                    <form action="<?php echo e(route('client.setup-password', ['token' => $token])); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-4">
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/auth/setup-password.blade.php ENDPATH**/ ?>