...
<div class="flex items-center gap-3">
    ...
    <a href="<?php echo e(route('admin.management.login-logs.export-csv')); ?>?<?php echo e(http_build_query(request()->only('type', 'status'))); ?>"
    ...
    <form method="GET" class="flex flex-wrap items-end gap-3">
        ...
        <div>
            ...
            <select name="status" class="px-3 py-2 text-sm border border-gray-200 rounded-xl bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500">
                ...
                <option value="logged_out" <?php echo e(request('status') === 'logged_out' ? 'selected' : ''); ?>>Logged Out</option>
            </select>
        </div>
        <div>
...
<tr class="hover:bg-gray-50/50">
    ...
    <td class="px-5 py-4 text-center">
        ...
        <?php elseif($log->live_status === 'expired'): ?>
