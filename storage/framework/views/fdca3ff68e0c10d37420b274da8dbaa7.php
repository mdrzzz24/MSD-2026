...
<head>
    ...
    <title>Scans — <?php echo e($track->name ?: $track->title); ?> — <?php echo e(config('app.name')); ?></title>
...
<header class="sticky top-0 z-30 bg-white/80 backdrop-blur border-b border-gray-200">
    <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
        <div class="flex items-center gap-4">
            ...
            <h1 class="text-lg font-bold text-gray-900">Scans — <?php echo e($track->name ?: $track->title); ?></h1>
        </div>
        <div class="flex items-center gap-2">
            <a href="<?php echo e(route('admin.tracks.export', $track)); ?>" class="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-medium rounded-lg border border-gray-200 text-gray-600 bg-white hover:bg-gray-50 transition">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                Export CSV
            </a>
            <a href="<?php echo e(route('admin.tracks.registrants', $track)); ?>" class="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-medium rounded-lg border border-gray-200 text-gray-600 bg-white hover:bg-gray-50 transition">
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-gray-500">Total: <strong><?php echo e($visits->total()); ?></strong> scan(s)</p>
            </div>
        </div>
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr class="hover:bg-gray-50/50 transition">
                            ...
                            <td class="px-4 py-3.5 max-w-0">
                                <a href="<?php echo e(route('admin.registrants.show', $visit->registrant)); ?>" class="text-sm font-semibold text-indigo-600 hover:text-indigo-800 hover:underline truncate block" title="<?php echo e($visit->registrant->display_name ?: $visit->registrant->name); ?>">
                                    <?php echo e($visit->registrant->display_name ?: $visit->registrant->name); ?>

                                </a>
                                <span class="text-xs text-gray-400 truncate block" title="<?php echo e($visit->registrant->email); ?>"><?php echo e($visit->registrant->email); ?></span>
                            </td>
                            <td class="px-4 py-3.5 hidden md:table-cell max-w-0">
                                <?php if($visit->agendaItem): ?>
                                    <span class="text-sm text-gray-600 truncate block" title="<?php echo e($visit->agendaItem->title); ?>"><?php echo e($visit->agendaItem->title); ?></span>
                                <?php else: ?>
                            ...
                            <td class="px-4 py-3.5">
                                <?php if($visit->left_at): ?>
                                    <span class="inline-flex items-center gap-1 text-sm font-medium text-red-600 whitespace-nowrap">
                                        ...
                                        <?php echo e($visit->left_at->format('d M Y, H:i')); ?>
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/admin/tracks/visitors.blade.php ENDPATH**/ ?>