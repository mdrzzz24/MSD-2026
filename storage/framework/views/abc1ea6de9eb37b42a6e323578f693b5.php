                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <textarea id="notes" name="notes" rows="3" maxlength="1000"
                                              class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 focus:bg-white transition resize-none"><?php echo e(old('notes', $registrant->notes)); ?></textarea>
                                </div>
                                <div>
                                    ...
                                    <textarea id="admin_notes" name="admin_notes" rows="3" maxlength="500"
                                              class="w-full px-4 py-2.5 text-sm border border-gray-200 rounded-xl bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 focus:bg-white transition resize-none"><?php echo e(old('admin_notes', $registrant->admin_notes)); ?></textarea>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\2026-Testing\resources\views/admin/registrants/edit.blade.php ENDPATH**/ ?>