...
<head>
    ...
    <title>Add General Session — <?php echo e(config('app.name')); ?></title>
...
<header class="sticky top-0 z-30 bg-white/80 backdrop-blur border-b border-gray-200">
    <div class="flex items-center h-16 px-4 sm:px-6 lg:px-8 gap-4">
        ...
        <h1 class="text-lg font-bold text-gray-900">Add General Session</h1>
    </div>
</header>
...
<div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8">
    ...
    <?php endif; ?>
    <form action="<?php echo e(route('admin.general-sessions.store')); ?>" method="POST" class="space-y-4">
        <?php echo csrf_field(); ?>
        <div>
        ...
        <div>
            ...
            <input type="text" name="topic_headline" value="<?php echo e(old('topic_headline')); ?>" maxlength="255"
                   class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500"
        ...
        <div>
            ...
            <textarea name="description" rows="4"
                      class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500"
                      placeholder="Session description or agenda notes..."><?php echo e(old('description')); ?></textarea>
        </div>
            ...
            <div>
                ...
                <select name="room" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500">
                    ...
                    <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($room->name); ?>" <?php echo e(old('room') == $room->name ? 'selected' : ''); ?>><?php echo e($room->name); ?></option>
                    ...
                    <?php $__currentLoopData = $speakers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl border border-gray-200 cursor-pointer hover:border-indigo-300 transition">
                            <input type="checkbox" name="speaker_ids[]" value="<?php echo e($sp->id); ?>"
                                   <?php echo e(in_array($sp->id, old('speaker_ids', [])) ? 'checked' : ''); ?>
        ...
        <div>
            ...
            <textarea name="key_highlights" rows="3"
                      class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500"
                      placeholder="One bullet point per line…"><?php echo e(old('key_highlights')); ?></textarea>
        </div>
        <div class="flex items-center gap-4 pt-2">
            <label class="flex items-center gap-2 cursor-pointer">
                <input type="checkbox" name="is_full_row" value="1" <?php echo e(old('is_full_row') ? 'checked' : ''); ?> class="w-4 h-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/admin/general-sessions/create.blade.php ENDPATH**/ ?>