    ...
    <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
        <div>
            <h1 class="text-lg font-bold text-gray-900">
                <?php if(isset($track)): ?> Track Registrants: <?php echo e($track->name ?: $track->title); ?> <?php else: ?> Agenda Registrants <?php endif; ?>
            </h1>
...
<?php /**PATH /Users/mdrz/2026/MSD26/resources/views/admin/agenda-registrants/index.blade.php ENDPATH**/ ?>