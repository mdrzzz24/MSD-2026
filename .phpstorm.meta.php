...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.guards.registrant.driver' => 'string',
            'auth.guards.registrant.provider' => 'string',
            'auth.providers.users.driver' => 'string',
            'auth.providers.users.model' => 'string',
            'auth.providers.registrants.driver' => 'string',
            'auth.providers.registrants.model' => 'string',
            ...
            'filesystems.links./Users/mdrz/2026/MSD26/public/storage' => 'string',
...
'auth.guards.web.provider','auth.guards.registrant.driver','auth.guards.registrant.provider','auth.providers.users.driver','auth.providers.users.model',
'auth.providers.registrants.driver','auth.providers.registrants.model','auth.passwords.users.provider','auth.passwords.users.table','auth.passwords.users.expire',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/mdrz/2026/MSD26/public/storage',
...
'signed','throttle','verified','admin','super_admin',);
        registerArgumentsSet('routes', 'home1',
'register.submit','register.success','feedback.form','feedback.store','registrant.qr-scan',
'registrant.qr-checkin','registrant.qr-share','client.setup-password','client.setup-password','login',
'login.attempt','logout','registrant.login','registrant.logout','qr-login.form',
'qr-login.verify-email','qr-login.authenticate','registrant.dashboard','registrant.workshop.register','registrant.workshop.unregister',
'registrant.agenda.register','registrant.agenda.unregister','admin.dashboard','admin.dashboard.data','admin.registrants.index',
'admin.registrants.show','admin.registrants.edit','admin.registrants.update','admin.registrants.destroy','admin.registrants.approve',
'admin.registrants.reject','admin.registrants.resend-credentials','admin.registrants.bulk-approve','admin.registrants.bulk-reject','admin.registrants.export-csv',
'admin.registrants.notes','admin.toggle-registration','admin.mail-settings.edit','admin.mail-settings.update','admin.mail-settings.test',
'admin.templates.index','admin.templates.upload','admin.templates.upload.store','admin.templates.create','admin.templates.create-from-fallback',
'admin.templates.store','admin.templates.edit','admin.templates.update','admin.templates.destroy','admin.templates.toggle',
'admin.templates.preview','admin.templates.logs','admin.templates.send-reminder','admin.templates.toggle-auto-email','admin.admin-emails.index',
'admin.admin-emails.create','admin.admin-emails.store','admin.admin-emails.edit','admin.admin-emails.update','admin.admin-emails.destroy',
'admin.admin-emails.send-test','admin.bounce-check.run','admin.workshops.create','admin.workshops.store','admin.workshops.edit',
'admin.workshops.update','admin.workshops.destroy','admin.workshops.toggle','admin.agenda.index','admin.agenda.create',
'admin.agenda.store','admin.agenda.edit','admin.agenda.update','admin.agenda.destroy','admin.agenda.merge',
'admin.agenda.feedback.toggle','admin.feedback.index','admin.agenda.feedback.show','admin.agenda.feedback.export-csv','admin.feedback.templates',
'admin.feedback.templates.create','admin.feedback.templates.store','admin.feedback.templates.edit','admin.feedback.templates.update','admin.feedback.templates.destroy',
'admin.agenda.feedback.questions','admin.agenda.feedback.apply-template','admin.agenda.feedback.questions.clear','admin.agenda.feedback.questions.update','admin.time-slots.index',
'admin.time-slots.store','admin.time-slots.update','admin.time-slots.destroy','admin.rooms.index','admin.rooms.store',
'admin.rooms.update','admin.rooms.destroy','admin.rooms.floor.store','admin.rooms.floor.update','admin.rooms.floor.destroy',
'admin.floors.index','admin.','admin.','admin.','admin.speakers.index',
'admin.speakers.store','admin.speakers.update','admin.speakers.destroy','admin.speakers.toggle','admin.tracks.store',
'admin.tracks.update','admin.tracks.destroy','admin.tracks.toggle','admin.email-logs.index','admin.email-logs.export-csv',
'admin.email-logs.show','admin.email-logs.reminder-form','admin.email-logs.send-reminder','admin.tracks.registrants.approve','admin.tracks.registrants.reject',
'admin.workshops.index','admin.workshops.registrants','admin.workshops.registrants.export-csv','admin.tracks.index','admin.tracks.registrants',
'admin.workshop-registrants.index','admin.workshop-registrants.export-csv','admin.workshops.registrants.approve','admin.workshops.registrants.reject','admin.agenda-registrants.index',
'admin.agenda-registrants.detail','admin.agenda-registrants.approve','admin.agenda-registrants.reject','admin.management.utm','admin.management.utm.export-csv',
'admin.management.utm-links.store','admin.management.utm-links.update','admin.management.utm-links.destroy','admin.management.qr','admin.management.qr.export-csv',
'admin.management.checkin','admin.management.checkin.export-csv','admin.management.users','admin.management.users.store','admin.management.users.update',
'admin.management.users.destroy','admin.management.users.invite','admin.management.users.invite','admin.management.groups.index','admin.management.groups.create',
'admin.management.groups.store','admin.management.groups.edit','admin.management.groups.update','admin.management.groups.destroy','storage.local',
'storage.local.upload',);
        registerArgumentsSet('views', 
'admin.admin-emails.create','admin.admin-emails.edit','admin.admin-emails.index','admin.agenda-registrants.detail','admin.agenda-registrants.index',
'admin.agenda.create','admin.agenda.edit','admin.agenda.feedback','admin.agenda.feedback-index','admin.agenda.index',
'admin.dashboard','admin.email-logs.index','admin.email-logs.send-reminder','admin.email-logs.show','admin.feedback.apply-template',
'admin.feedback.template-form','admin.feedback.templates','admin.floors.index','admin.groups.form','admin.groups.index',
'admin.mail-settings','admin.management.checkin-log','admin.management.qr-codes','admin.management.users','admin.management.utm',
'admin.partials.mobile-sidebar','admin.partials.notification','admin.partials.sidebar','admin.qr-scan','admin.qr-share',
'admin.registrant-detail','admin.registrants.edit','admin.registrants.index','admin.rooms.index','admin.speakers.index',
'admin.templates.create','admin.templates.edit','admin.templates.index','admin.templates.logs','admin.templates.preview',
'admin.templates.send-reminder','admin.templates.upload','admin.time-slots.index','admin.tracks.index','admin.tracks.registrants',
'admin.users.invite','admin.workshop-registrants.detail','admin.workshop-registrants.index','admin.workshops.create','admin.workshops.edit',
'admin.workshops.index','admin.workshops.registrants','auth.login','auth.qr-login','auth.setup-password',
'emails.client-invitation','emails.html-wrapper','emails.registrant-approved','emails.registrant-credentials','emails.registrant-rejected',
'emails.registration-clean','emails.reminder','emails.track-approved','emails.track-rejected','emails.workshop-approved',
'emails.workshop-rejected','feedback.form','home','home1','home2',
'home3','registrant.dashboard','registrant.login','registrant.success','welcome',
...
'APP_URL','LOG_CHANNEL','LOG_LEVEL','DB_CONNECTION','DB_HOST',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','BOUNCE_IMAP_HOST','BOUNCE_IMAP_PORT','BOUNCE_IMAP_USERNAME',
'BOUNCE_IMAP_PASSWORD','BOUNCE_IMAP_MAILBOX',);
