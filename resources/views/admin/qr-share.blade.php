...
<head>
    ...
    <title>QR Code — {{ $registrant->name }}</title>
...
<body class="bg-gray-50 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-lg max-w-sm w-full overflow-hidden">
        <div class="text-center">
            <img src="{{ asset('img/QRHeader.png') }}" alt="Metrodata Solution Day 2026" class="w-full h-auto">
        </div>
        <div class="p-6 text-center">
            <img src="{{ $registrant->qr_code_url }}" alt="QR Code" class="w-56 h-56 mx-auto rounded-lg border border-gray-200">
