...
<aside class="hidden lg:flex lg:flex-col w-64 bg-white border-r border-gray-200 fixed inset-y-0 z-40">
    ...
    <nav class="flex-1 px-3 py-6 space-y-1 overflow-y-auto">
        ...
        <a href="{{ route('admin.room-accounts.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium {{ request()->routeIs('admin.room-accounts.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-100' }} transition">
        ...
        <a href="{{ route('admin.feedback-registrants.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium {{ request()->routeIs('admin.feedback-registrants.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-100' }} transition">
        ...
        <a href="{{ route('admin.regist-confirmation.unbalanced') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium ml-6 {{ request()->routeIs('admin.regist-confirmation.unbalanced') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-100' }} transition">
        ...
        <a href="{{ route('admin.data-cleaning.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium ml-6 {{ request()->routeIs('admin.data-cleaning.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-100' }} transition">
        ...
        @if (Auth::user()->isSuperAdmin())
        <a href="{{ route('admin.general-sessions.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium {{ request()->routeIs('admin.general-sessions.*') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:bg-gray-100' }} transition">
        ...
        {{-- ═══ Communications ═══ --}}
        @if (Auth::user()->isSuperAdmin() || Auth::user()->isAdmin() || Auth::user()->hasPermission('email_templates') || Auth::user()->hasPermission('utm_sources') || Auth::user()->hasPermission('qr_codes'))
        <div class="pt-4">
