...
<head>
<meta charset="utf-8">
<title>Name Badges — {{ config('app.name') }}</title>
...
<div class="toolbar">
    ...
    <span class="sub">{{ $registrants->count() }} participant(s) · {{ config('app.name') }} 2026</span>
        ...
        <div class="badge-grid">
            ...
            <div class="badge">
                <div class="badge-header">
                    <div class="brand">
                        <img src="{{ asset('img/logo-msd.png') }}" alt="MSD">
                        <div class="evt">
                ...
                <div class="badge-body">
                    ...
                    @if ($r->company)<div class="badge-company">{{ $r->company }}</div>@endif
                    @if ($r->job_title)<div class="badge-title">{{ $r->job_title }}</div>@endif
                    <div class="badge-foot">
                        <div class="qr"><img src="{{ $r->qr_code_url }}" alt="QR"></div>
                        <div class="meta">
                            <div class="cap">Reg Code</div>
                            <div class="code">{{ $r->unique_code }}</div>
                        </div>
                    </div>
                </div>
            </div>
