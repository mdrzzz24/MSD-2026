...
<div class="p-4 sm:p-6 lg:p-8">
    ...
    <form action="{{ route('admin.templates.update', $template) }}" method="POST">
        ...
        <div class="mt-4 flex justify-end gap-2">
            <a href="{{ route('admin.templates.preview', $template) }}" target="_blank" class="px-5 py-3 text-sm font-medium rounded-xl bg-gray-100 text-gray-700 hover:bg-gray-200 transition">🔍 Open in Tab</a>
...
(function() {
    ...
    function updatePreview() {
        var html = editor.value
            ...
            .replace(/\{\{\s*qr_link\s*\}\}/g, '{{ url('/qr-view/sample-qr-token') }}');
