...
<body class="min-h-screen flex font-sans">
    ...
    <div class="flex-1 flex items-center justify-center bg-gray-50 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-md animate-fade-in">
            ...
            {{-- Mobile key visual --}}
            <div class="lg:hidden relative mb-8 overflow-hidden rounded-2xl" style="background: url('{{ asset('img/QRHeader.png') }}') no-repeat center center; background-size: cover; min-height: 200px;">
                {{-- <div style="position:absolute;inset:0;background:linear-gradient(135deg,rgba(5,13,42,.6),rgba(10,26,74,.4),rgba(5,13,42,.7));z-index:1;"></div>
                <div class="relative z-10 flex flex-col items-center justify-center py-10 px-6 text-center">
                    <img src="{{ asset('img/logo-msd.png') }}" alt="MSD" style="height:60px;width:auto;filter:drop-shadow(0 0 20px rgba(0,212,255,.3))" class="mx-auto mb-3">
                    <h1 class="text-2xl font-extrabold text-white">MSD 2026</h1>
                    <p class="text-sm text-white/70 mt-1">Winning with AI</p>
                </div> --}}
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/60 p-8 sm:p-10 border border-gray-100">
                ...
                <p class="text-gray-500 text-sm mb-8">Already have an account? Sign in below, or <a href="{{ route('home1', request()->only(['utm_source', 'utm_medium', 'utm_campaign', 'utm_term', 'utm_content'])) }}#register" style="color:#e91e63;" class="font-semibold hover:underline">register here</a>.</p>
                <div class="text-center mb-6">
                    <a href="{{ route('qr-login.form') }}" class="text-sm font-medium hover:underline inline-flex items-center gap-1.5" style="color:#e91e63;">
            ...
            <p class="text-center text-xs text-gray-400 mt-6">
                {{-- Don&apos;t have an account? <a href="{{ route('home1', request()->only(['utm_source', 'utm_medium', 'utm_campaign', 'utm_term', 'utm_content'])) }}#register" style="color:#e91e63;" class="font-semibold hover:underline">Register here</a> --}}
            </p>
