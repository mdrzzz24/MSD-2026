...
<head>
    ...
    <title>QR Login — {{ config('app.name') }}</title>
...
<body class="min-h-screen flex font-sans">
    ...
    <div class="flex-1 flex items-center justify-center bg-gray-50 px-4 sm:px-6 lg:px-8">
        <div class="w-full max-w-md animate-fade-in">
            ...
            {{-- Mobile key visual --}}
            <div class="lg:hidden relative mb-8 overflow-hidden rounded-2xl" style="background: url('{{ asset('img/QRHeader.png') }}') no-repeat center center; background-size: cover; min-height: 180px;">
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/60 p-8 sm:p-10 border border-gray-100">
                ...
                <div id="stepEmail">
                    ...
                    <div class="flex gap-2">
                        <input type="email" id="emailInput" value="{{ old('email') }}"
                    ...
                    <p class="text-xs text-gray-400 mt-3 text-center">
                        <a href="{{ route('login') }}" style="color:#e91e63;" class="hover:underline">Sign in with password</a>
                        &middot;
                        <a href="{{ route('home1') }}#register" style="color:#e91e63;" class="hover:underline">Register</a>
                    </p>
                </div>
