...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0">
<tr><td style="padding:4px 0;font-size:14px;color:#374151;"><strong style="color:#050d2a;">Email:</strong> {{ $registrant->email }}</td></tr>
<tr><td style="padding:4px 0;font-size:14px;color:#374151;"><strong style="color:#050d2a;">Password:</strong> <span style="font-family:monospace;background:#e5e7eb;padding:2px 10px;border-radius:6px;font-size:13px;color:#050d2a;font-weight:700;">{{ $plainPassword }}</span></td></tr>
</table>
</td></tr>
</table>
</td></tr>
...
<a href="{{ route('registrant.login') }}" style="display:inline-block;padding:12px 36px;background:linear-gradient(135deg,#ff3d6e,#e91e63);color:#ffffff;text-decoration:none;border-radius:999px;font-size:14px;font-weight:700;box-shadow:0 4px 14px rgba(233,30,99,0.3);">Login Now</a>
</td></tr>
