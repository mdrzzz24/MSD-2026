...
@if ($adminNotes)
<p style="margin:12px 0 0;padding:14px 18px;background:#fef2f2;border:1px solid #fecaca;border-radius:10px;font-size:14px;color:#991b1b;line-height:1.5;"><strong>Reason:</strong> {{ $adminNotes }}</p>
@endif
</td></tr>
</table>
</td></tr>
