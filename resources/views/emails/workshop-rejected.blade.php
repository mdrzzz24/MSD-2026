...
<p style="margin:12px 0 0;font-size:15px;color:#6b7280;line-height:1.6;">We regret to inform you that your registration for the workshop <strong style="color:#050d2a;">{{ $workshopName }}</strong> has been <strong style="color:#ef4444;">rejected</strong>.</p>
@if ($adminNotes)
