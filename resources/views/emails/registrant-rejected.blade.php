...
<tr><td style="text-align:center;padding-bottom:20px;">
<p style="margin:0;font-size:15px;color:#6b7280;line-height:1.6;">Hello <strong style="color:#050d2a;">{{ $registrant->name }}</strong>,</p>
...
<p style="margin:16px 0 0;padding:14px 18px;background:#fef2f2;border:1px solid #fecaca;border-radius:10px;font-size:14px;color:#991b1b;line-height:1.5;"><strong>Reason:</strong> {{ $registrant->admin_notes }}</p>
@endif
</td></tr>
</table>
</td></tr>
