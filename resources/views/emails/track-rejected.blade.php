...
<p style="margin:12px 0 0;font-size:15px;color:#6b7280;line-height:1.6;">We regret to inform you that your registration for the session <strong style="color:#050d2a;">{{ $sessionName }}</strong> has been <strong style="color:#ef4444;">rejected</strong>.</p>
@if ($adminNotes)
<p style="margin:16px 0 0;padding:14px 18px;background:#fef2f2;border:1px solid #fecaca;border-radius:10px;font-size:14px;color:#991b1b;line-height:1.5;"><strong>Reason:</strong> {{ $adminNotes }}</p>
@endif
</td></tr>
</table>
</td></tr>
